...
class LoginForm extends Component{
    ...
    render(){
        ...
        return(
            ...
            <div><img src={websiteLogoInForm} alt="website logo" /></div>
            <label htmlFor="username">USERNAME</label>
            <br />
            <input type="text" value={username} onChange={this.onGetUsername} placeholder="username" id="username" />
            <br />
            <br />
            <label htmlFor="password">PASSWORD</label>
            <br />
            <input type="text" value={password} onChange={this.onGetPassword} placeholder="password" id="password" />
            <br />
            <br />
